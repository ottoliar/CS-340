...
VALUES ((SELECT id FROM category_tbl WHERE name = 'phone' AND subcategory = 'maybe a tablet?'),
	'Samsung Atlas', '1970-1-2', true);
...
-- isbroken - False
INSERT INTO device (cid, name, received, isbroken)
VALUES ((SELECT id FROM category_tbl WHERE name = 'tablet' AND subcategory = 'but kind of a laptop'),
	'Nokia', '1999-5-6', false);
...
-- isbroken - False
INSERT INTO device (cid, name, received, isbroken)
VALUES ((SELECT id FROM category_tbl WHERE name = 'tablet' AND subcategory = 'ereader'), 
